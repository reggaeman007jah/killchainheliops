...
["Killchain Heli-Ops", "wayfinderAdjLZ", "Mission Course Direction", {_this spawn RGGw_fnc_wayF_adj}, ""] call CBA_fnc_addKeybind; // when run, this triggers a one-shot course direction to the current target LZ 
["Killchain Heli-Ops", "wayfinderAdjBase", "Base Direction", {_this spawn RGGw_fnc_wayF_adjBase}, ""] call CBA_fnc_addKeybind; // when run, this triggers a one-shot course direction to Pathfinder base 
["Killchain Heli-Ops", "decOnStat", "Declare Raptor On-Station", {[player] spawn RGGo_fnc_order_decOnStat}, ""] call CBA_fnc_addKeybind; // when run, this triggers a one-shot course direction to Pathfinder base 